...
lpaData <- inspectProfiles(whichModel="clo", prepData=data2, paramEst=clo$params, n_profiles=2, minMax = c(.1, .9), dist0name="men", dist1name="women")
```
...
```{r}
plots <- cloPlotTraj(prepData=data2, paramEst=clo$params, n_profiles=2, time_length=100, minMax=c(.1, .9), dist0name="men", dist1name="women")
```
...
```{r, eval=FALSE}
plotDataByProfile(prepData=data2, fullData=fullData, n_profiles= 2, dist0name="men", dist1name="women",
                  plot_obs_name="Dial")
```
...
```{r, fig.width=4}
sysIn <- sysVarIn(fullData=fullData, sysVar_name="ambiv", sysVarType="indiv", n_profiles=2, dist0name="Men",
                  dist1name="Women")
