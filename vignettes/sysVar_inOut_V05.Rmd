...
We start with an example of a normally distributed dyadic system variable, "dyadSup", which was the average self-report for each couple of their emotion suppression during a conversation.

```{r}
sysOut <- sysVarOut(fullData=fullData, sysVar_name="dyadSup", sysVarType="dyadic", dist0name="Men", dist1name="Women")
```
