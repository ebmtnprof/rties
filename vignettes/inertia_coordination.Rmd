...
The previous output can be used to make decisions about which model and how many profiles to use. We recommend reading some papers on latent profile analysis if this is new to you. Here we choose model 6 with 2 profiles. The next step is to investigate the makeup of the estimated profiles using the "estimate_profiles" function.
```{r, fig.width=4}
